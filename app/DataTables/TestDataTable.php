        ...
        return datatables()
            ...
            ->addColumn('action',  function($row){
                $actionBtn = '
                 ...
                 '.csrf_field().'
                 '.method_field("DELETE").'
                 <a href="" class="edit btn btn-success btn-sm">تعديل</a>
                 <button class=" delete_btn delete btn btn-danger btn-sm"
                     onclick="return confirm(\'سوف يتم حذف المسؤل نهائينا هل تريد الحذف؟\')">حذف</a>
                 </form>';
                return $actionBtn;
            })
            ->editColumn('room_background', function ($row) {
                return "<img src=\"http://127.0.0.1:8000/storage/images/162820484816.png\" height=\"50\"/>";
